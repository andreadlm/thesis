...
\begin{itemize}
    ...
    \item \mintinline{Lean}|injection e|: assumendo che \mintinline{Lean}|e| sia un termine nel contesto locale di tipo \mintinline{Lean}|(c t₁ ... tₓ) = (c r₁ ... rₓ)|, con \mintinline{Lean}|c| costruttore di un tipo induttivo, sfrutta il fatto che i costruttori siano funzioni inettive e produce $x$ nuove ipotesi \mintinline{Lean}|(t₁ = r₁) | ... \mintinline{Lean}|(tₓ = rₓ)|
\end{itemize}
